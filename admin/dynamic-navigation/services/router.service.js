...
System.register(['angular2/core', 'angular2/router', '../admin'], function(exports_1, context_1) {
    "use strict";
            ...
            DynamicRouteConfigurator = (function () {
                ...
                DynamicRouteConfigurator.prototype.setRoutes = function (route, target) {
                    ...
                    this.addRoute(target.constructor, new router_1.AsyncRoute({
                        path: route.path,
                        loader: function () { return System.import(route.url).then(function (resp) { target.appRoutes = _this.getAppRoutes(target); return resp[route.component]; }); },
                        name: route.name
                    }));
                };
